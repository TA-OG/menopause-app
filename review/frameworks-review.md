...
Shown when their **menopause stage** is any of: "menopause", "postmenopause", "surgical".

### Food & diet

- **700–1200mg calcium daily — from food first**  _(high priority)_
  Oestrogen directly regulates bone resorption. Its decline accelerates bone loss by up to 20% in the first 5–7 years post-menopause. Calcium intake is fundamental. Aim for 700–1200mg daily from food: dairy (milk, cheese, yoghurt), fortified plant milks, canned sardines and salmon (eat the bones), broccoli, kale, almonds, and tofu made with calcium sulphate. Food-based calcium is better absorbed than supplements. Supplementing above 1000mg daily from tablets alone has weak evidence and may increase cardiovascular risk.
...
- **Weight-bearing exercise is medicine for bones**  _(high priority)_
...
- **Ask your GP about a DEXA scan — know your baseline**  _(high priority)_
...
- **Calcium supplements — only if diet is insufficient**  _(low priority)_
  Calcium supplementation (500mg daily, no more) is appropriate only if your dietary calcium consistently falls below 700mg. Most women who eat dairy or use fortified plant milks reach this from food. Calcium carbonate is best taken with food; calcium citrate can be taken without food. Do not exceed 1000mg total daily from food and supplements combined without GP guidance.
  _Disclaimer: Calcium supplements above 1000mg/day may increase cardiovascular risk in some studies. Do not supplement without assessing dietary intake first. Consult your GP if you have a history of kidney stones, hypercalcaemia, or cardiovascular disease._
- **Vitamin K2 (MK-7) — routes calcium to bones, not arteries**  _(medium priority)_
  Vitamin K2 (menaquinone-7, 100–200mcg daily) activates proteins that direct calcium into bone and teeth rather than arterial walls. It works synergistically with vitamin D3 — take them together. Dietary sources are limited (natto, hard cheeses, egg yolks). Evidence for fracture prevention is emerging but the mechanism is well-established.
  _Disclaimer: Vitamin K2 interacts with warfarin and other anticoagulants and can reduce their effectiveness. Do not take if you are on anticoagulant medication without explicit GP approval._

---

## Universal Foundations

Shown to **every user**, regardless of their answers.

### Food & diet

- **Meal timing and frequency — different by stage, and by how you're doing**  _(high priority)_
  There's no universal rule backed by strong evidence here, but a pattern some women and practitioners find works: in perimenopause, eating breakfast within an hour of waking, in 3 meals a day (4–5 smaller ones if energy is a struggle). In menopause and postmenopause, some find breaking the fast a little later — around 10–11am — sits better, with 2–3 meals a day. Treat this as a starting point to experiment with, not a fixed prescription. But this flexes: if you're struggling with sleep, anxiety, brain fog or low energy, fasting is best avoided altogether at any stage — your body needs consistent fuel, not less of it. More frequent, smaller meals (4–5) tend to serve you better than 2–3 larger ones in that case, and caffeine and alcohol are usually the first things worth reducing, since both directly worsen these exact symptoms.
...
- **Vitamin D3 (+K2) — ideally guided by a blood test**  _(high priority)_
  Low vitamin D is very common in the UK, and it matters more through menopause because falling oestrogen already affects bone density. Many women take a supplement in the range of 1000–4000 IU a day, ideally guided by a blood test rather than guesswork — testing first tells you whether you need it at all, and how much. Some women choose a D3 (cholecalciferol) and K2 combination product, since K2 supports how the body uses calcium. This is a suggestion that helps many women, not medical advice, so please check with your GP or pharmacist first.
  _Targets: fatigue, mood changes, joint pain_
  _Disclaimer: Vitamin D toxicity can occur at very high doses (above 4000 IU/day long-term). The K2 component can interact with warfarin and other anticoagulant medication — do not take this combination if you are on anticoagulants without explicit GP approval. Always test before supplementing above 2000 IU and consult your GP if you have kidney disease, hypercalcaemia, or sarcoidosis._
- **Magnesium — the form matters**  _(high priority)_
  If you try magnesium, the form makes more difference than most people realise. Women who take it commonly use somewhere around 200–400mg a day, starting at the lower end. Glycinate is gentler on the gut and less likely to cause loose stools — usually the better fit if what you're after is sleep, calm, or nervous system support without a laxative effect. Citrate has a natural laxative effect, so it's the better choice if you're also dealing with constipation or want support with bowel movements — though it may cause loose stools if the dose is too high. Both are better absorbed than magnesium oxide, which is cheaper but poorly absorbed and mostly used for its laxative effect rather than raising magnesium levels.
...
- **Digestive enzymes and HCL — for bloating, reflux, and absorption**  _(low priority)_
  Some women find digestive enzymes taken with meals helpful if bloating or discomfort after eating is a regular thing. Some practitioners suggest reduced stomach acid can play a role in this for some women — it's a contested idea rather than a settled one, so worth treating as a theory to discuss with a GP or practitioner rather than a given. Betaine Hydrochloride (HCL) is one option some women try under guidance, alongside protein-containing meals. Self-adjusting the dose based on how it feels isn't something we'll spell out here — that's exactly the kind of thing a practitioner should walk you through in person, given how unsuitable it is for some people.
  _Disclaimer: HCL is not suitable for everyone — particularly anyone with active ulcers, gastritis, or taking anti-inflammatory medications — so it needs a GP or practitioner check before starting, including for guidance on dose._
- **Calcium D-Glucarate — for oestrogen clearance support**  _(medium priority)_
  Some women look at calcium D-glucarate, often cited around 500mg–1g/day in doses people report using, on the theory that it supports the liver in clearing oestrogen rather than it being reabsorbed through the gut. This idea comes up particularly for women with a history of oestrogen-sensitive conditions like endometriosis, adenomyosis or fibroids. It's worth being honest that the human evidence for this specific effect is limited — most of what's known comes from lab and animal research rather than clinical trials in women. If it's something you want to explore, broader support for oestrogen clearance — liver function, fibre, cruciferous vegetables, reducing alcohol and xenoestrogen exposure — has a firmer evidence base and is worth prioritising either way.
  _Disclaimer: Always check with your GP or pharmacist before starting, especially if you take any prescribed medications or have a personal or family history of hormone-sensitive conditions. Calcium D-glucarate can affect how the liver processes some medications, so this check matters even more if you take regular prescriptions._

---

## High Stress & Cortisol Load

Shown when their **stress level** is any of: "high", "very high".
...
- **Identify one daily non-negotiable recovery activity**  _(high priority)_
  Under high stress, recovery activities are the first things dropped — exactly when they are most needed. Research on stress resilience consistently shows that a single daily "micro-recovery" activity of 10–20 minutes — a walk outside, 10 minutes of stretching, 5 minutes of deliberate breathing, a cup of tea without a screen — has an outsized effect on daily cortisol regulation. This is not self-indulgence. It is the maintenance that prevents burnout. Identify one specific activity and protect it as an appointment with yourself.
  _Targets: anxiety, mood changes, fatigue, sleep problems_
...
- **The physiological sigh — a 5-second cortisol interrupt**  _(high priority)_
  The physiological sigh (a double inhale through the nose followed by a long, slow exhale through the mouth) activates the parasympathetic nervous system faster than any other technique. It works by deflating over-inflated air sacs in the lungs that accumulate under stress. Use it at the onset of anxiety, before a difficult conversation, or when you notice tension building. Stanford neuroscientist Andrew Huberman's work on the mechanism is widely available if you want to understand the science.
  _Targets: anxiety, hot flashes_
- **Menopause amplifies stress sensitivity — this is biology, not inadequacy**  _(medium priority)_
  Oestrogen modulates the brain's threat response by regulating serotonin and GABA receptors. As oestrogen declines, the stress response becomes more sensitive and harder to down-regulate. Things that you would have managed without much difficulty before perimenopause may now feel overwhelming. This is a neurological change, not a character change. Understanding this removes the self-blame that often compounds the stress itself.
  _Targets: anxiety, mood changes_

### Supplements

- **Ashwagandha (KSM-66) — the most evidence-backed adaptogen for cortisol**  _(high priority)_
  Ashwagandha root extract (KSM-66 or Sensoril formulation, 300–600mg daily) has the strongest clinical evidence of any adaptogen for reducing serum cortisol, perceived stress, and anxiety. Multiple randomised trials show significant reductions in cortisol and improved resilience scores at 8 weeks. Take with food. Avoid cheap, unstandardised ashwagandha powders — formulation matters for efficacy.
  _Targets: anxiety, sleep problems_
  _Disclaimer: Ashwagandha can interact with thyroid medications, sedatives, and immunosuppressants. Not suitable in pregnancy. Some people experience digestive upset — take with food. Consult your GP before use if you have thyroid conditions or take any regular medications._
- **L-theanine — calm without sedation for daytime anxiety**  _(medium priority)_
  L-theanine (200–400mg, taken with caffeine or alone) promotes alpha brain waves associated with calm alertness, without causing drowsiness. It has a rapid onset (30–60 minutes) making it useful for acute stressful situations. Used regularly, it reduces baseline anxiety. It is naturally found in green tea and is extremely well-tolerated with no known significant interactions.
  _Targets: anxiety_
  _Disclaimer: L-theanine is generally very well tolerated. Theoretical interactions with blood pressure medications exist — consult your GP if you take antihypertensives._

---

## Hot Flushes & Night Sweats

Shown when their **symptoms** is any of: "hot flashes", "night sweats".

### Food & diet

- **Prioritise cooling foods**  _(high priority)_
...
- **Exercise timing matters**  _(medium priority)_
  Regular moderate exercise reduces overall vasomotor symptom frequency — but exercising in heat or at high intensity can temporarily trigger flushes. Morning exercise in cool air tends to work better than evening exercise for women with significant night sweats.
- **Dress in natural fibre layers**  _(low priority)_
  Synthetic fabrics trap heat. Natural fibres — cotton, linen, bamboo, merino — allow moisture to evaporate. At work, a cardigan or blazer you can remove quickly gives more control than a single heavier garment. Keep a small fan on your desk if you can.
...
- **Sage — for hot flushes and night sweats**  _(medium priority)_
  Sage (Salvia officinalis) standardised extract has a small body of clinical evidence showing a modest reduction in hot flush frequency — studies typically used 300–600mg daily of a standardised extract, so that's a different thing to a cup of sage tea, which hasn't been studied at a known dose and doesn't carry the same evidence. Sage tea before bed is a traditional remedy for excessive sweating some women still reach for, just worth knowing it's a different basis to the extract research. Effects from the standardised extract take 4–8 weeks to build. Not a replacement for HRT if flushes are severe.
...
- **Vitamin E — for vasomotor symptoms**  _(low priority)_
  Some women try vitamin E, commonly around 400 IU/day, for reducing the frequency and severity of vasomotor symptoms including night sweats — the evidence for this specific effect is modest. 400 IU is a high supplemental dose, well above what you'd get from food.
  _Disclaimer: High-dose vitamin E can increase bleeding risk, particularly alongside anticoagulant or antiplatelet medication (warfarin, aspirin) or before surgery. Always check with your GP or pharmacist before starting, especially if you take any prescribed medications._
...
Shown when their **symptoms** is any of: "mood changes", "anxiety", "brain fog".
...
- **Gut health and the mood connection**  _(medium priority)_
  The gut-brain axis is well established, though it is often described loosely. Around 90% of the body's serotonin is made in the gut — but by your own enterochromaffin cells, not by gut bacteria, and that serotonin does not cross into the brain. What gut bacteria do is influence how much is produced, and communicate with the brain by other routes. Most of that work is mechanistic or from animal studies, though — human trials of fermented foods for mood are still limited, so treat the mood benefit as genuinely uncertain. Fermented foods are worth including for general gut health regardless: live yoghurt, kefir, kimchi, sauerkraut, miso. Aim for variety across the week rather than large amounts of one thing.
...
Shown when their **menopause stage** is "perimenopause".
...
- **Track your cycle — patterns reveal your hormonal picture**  _(high priority)_
  Perimenopause is defined by irregularity, but tracking your cycles reveals patterns in your symptoms that feel random until you see them visually. Apps like Clue or Natural Cycles (or a paper diary) let you log symptoms, mood, energy, and sleep alongside your cycle. Over 3–4 months, most women identify predictable windows (typically the week before a period, or the days around ovulation) when specific symptoms peak. This turns "I never know how I'll feel" into "I can prepare for Tuesday."
...
- **Grief is a legitimate response to perimenopause**  _(medium priority)_
  Perimenopause often arrives alongside significant life milestones — children leaving home, ageing parents, peak career demands, and a changing relationship with fertility. The emotional weight of this phase is real and frequently unacknowledged. Feeling grief, anger, or loss during this transition is not depression or weakness — it is a proportionate response to change. Naming this as grief, rather than fighting it, is often the first step toward moving through it.
- **The better you understand perimenopause, the less frightening it is**  _(medium priority)_
  Women who report the most difficult experiences of perimenopause are often those who had the least information before it started. Every symptom you're experiencing has a mechanism — a reason it's happening that is hormonal, not imagined. Dr Louise Newson's Balance app and website, the Menopause Charity, and books such as "Perimenopause Power" by Maisie Hill are evidence-informed resources. Knowledge does not fix symptoms, but it removes the fear that something is uniquely wrong with you.

### Supplements

- **Magnesium — for PMS-like symptoms, mood, and sleep**  _(high priority)_
  In early perimenopause, progesterone declines first — before oestrogen — producing PMS-like symptoms: irritability, breast tenderness, sleep disruption, and bloating in the luteal phase. Magnesium glycinate (300–400mg at night) directly addresses many of these symptoms by supporting GABA, reducing cortisol, and relaxing smooth muscle. It is one of the most evidence-backed supplements for perimenopause specifically.
  _Targets: sleep problems, mood changes, anxiety_
  _Disclaimer: Magnesium supplements are generally well-tolerated. High doses can cause loose stools — start at 200mg and increase slowly. Consult your GP before use if you have kidney disease or heart conditions, or take any prescribed medications._

---

## Getting Started with Movement

Shown when their **exercise level** is any of: "not active", "limited".

### Food & diet

- **Protein is even more important when you're not exercising regularly**  _(high priority)_
  Muscle mass is lost faster in women who are both sedentary and in menopause — a double hit. Without the stimulus of resistance exercise to trigger muscle protein synthesis, dietary protein becomes the primary lever for slowing muscle loss. Aim for 1.2–1.6g protein per kg of body weight daily. Spread it across meals — 25–30g per meal rather than most of it at dinner. This is not about building muscle — it is about protecting what you have.
  _Targets: fatigue, weight changes, joint pain_
- **Food as anti-inflammatory medicine — when movement is limited**  _(high priority)_
  When mobility is restricted, nutrition does more of the protective work. An anti-inflammatory eating pattern (olive oil, oily fish, berries, turmeric, ginger, dark leafy greens, colourful vegetables) helps manage the systemic inflammation that increases with both menopause and physical inactivity. This reduces joint pain and fatigue and supports metabolic health. These are accessible changes regardless of physical capacity.
  _Targets: joint pain, fatigue_

### Lifestyle

- **Start with 10 minutes — not 30**  _(high priority)_
  Recommendations to exercise for 150 minutes weekly are accurate but create a psychological barrier for women who are not currently active. The most evidence-backed approach for beginning a movement habit is to start with 10 minutes daily — short enough that it is hard to say no to, long enough to have a real effect. A 10-minute walk after one meal per day improves blood sugar, mood, and sleep. After 2 weeks, extend to 15 minutes. The habit comes before the duration.
  _Targets: fatigue, mood changes, weight changes, sleep problems_
- **Seated exercise counts — do not underestimate it**  _(high priority)_
  If mobility is limited, seated resistance exercises (chair squats, seated leg raises, seated upper body resistance band exercises) maintain muscle mass and improve circulation. Yoga for seniors or chair yoga (widely available on YouTube for free) improves flexibility and balance which directly reduces fall risk. Water aerobics (available at most community pools) is excellent for joint pain as water removes 90% of body weight impact. Movement at any capacity is therapeutic.
  _Targets: joint pain, fatigue_
- **Break up sitting every 60–90 minutes — even 2 minutes helps**  _(medium priority)_
  Prolonged sitting (more than 8 hours daily) is independently associated with poor metabolic health, even in people who also exercise. Setting a timer to stand and move for 2–3 minutes every 60–90 minutes — a walk to the kitchen, some calf raises, marching on the spot — reduces this risk. This is not instead of exercise; it is a separate, additional protective behaviour. A simple phone alarm works as the trigger.
  _Targets: fatigue, weight changes_

### Mindset & emotional

- **There is no failure here — just a starting point**  _(high priority)_
  Women who are not currently active often carry years of gym memberships that didn't stick, fitness programmes that felt designed for someone else, and internalised messages about discipline and willpower. None of that is relevant to where you start from today. Physical inactivity during menopause is extremely common — and extremely reversible. A 10-minute walk today is worth more than a perfect programme that doesn't happen. Start from exactly where you are.
- **If pain is limiting your movement — that deserves medical attention**  _(medium priority)_
  If joint pain, back pain, or another physical condition is the reason you are not active, this is worth pursuing with your GP rather than working around. Physiotherapy is often available on the NHS for joint pain and is dramatically more effective than rest for most conditions. A DEXA scan can identify whether osteoporosis is contributing to pain. Pain that limits activity is a medical problem — not a lifestyle choice. Address the barrier rather than accepting it.
  _Targets: joint pain_

### Supplements

- **Creatine monohydrate — supports muscle maintenance with minimal exercise**  _(medium priority)_
  Creatine monohydrate (3–5g daily) is one of the most extensively studied sports supplements and has emerging evidence for muscle preservation in older adults and postmenopausal women — even without significant exercise. It also shows promise for cognitive function and fatigue. It is safe, inexpensive, and effective in this dose range. Take consistently — the effects build over 4–6 weeks rather than immediately.
  _Targets: fatigue, weight changes_
  _Disclaimer: Creatine is very well-tolerated in the doses described. It may cause a small, temporary increase in body weight due to water retention in muscle. Consult your GP before use if you have kidney disease, as creatine increases creatinine levels (a kidney function marker) — this is not harmful but can complicate blood test interpretation._

---

## Sexual Health & Vaginal Wellbeing

Shown when their **symptoms** is any of: "low libido", "vaginal dryness".

### Food & diet

- **Eat for circulation — blood flow matters for libido**  _(medium priority)_
  Sexual arousal is fundamentally a vascular process. Foods that support healthy circulation include dark leafy greens (nitrates), pomegranate juice, dark chocolate (>70% cacao), beets, and oily fish (omega-3). Avoid high-sodium processed foods, which impair vascular function. Staying well-hydrated also reduces vaginal tissue dryness. These changes compound over weeks, not days.
  _Targets: low libido, vaginal dryness_
- **Omega-3 fats support tissue health and hormone production**  _(medium priority)_
  The adrenal glands continue to produce small amounts of oestrogen after menopause from cholesterol — a process supported by healthy fat intake. Include oily fish 2–3x weekly, flaxseed, walnuts, and avocado. Omega-3 also reduces vaginal inflammation. A well-nourished body with adequate essential fats maintains vaginal tissue health better than a low-fat diet.
  _Targets: vaginal dryness, low libido_

### Lifestyle

- **Vaginal moisturisers — use them regularly, not just during sex**  _(high priority)_
...
- **Pelvic floor exercises — for comfort, sensation, and continence**  _(high priority)_
  The pelvic floor muscles support the bladder, bowel, and uterus and are directly affected by oestrogen decline. Strengthening them (Kegel exercises: hold for 10 seconds, release, repeat 10 times, 3 sets daily) improves sensation during sex, reduces urgency incontinence, and supports pelvic organ health. If reminders help you keep it up, Squeezy — developed by NHS pelvic health physiotherapists — guides you through a progressive programme. The standalone app is a paid one, but some pelvic health clinics provide a connected version free to their patients, so it is worth asking. You can also ask your GP to refer you to an NHS pelvic health physiotherapist, which is free and is the better route if symptoms are affecting you day to day.
  _Targets: vaginal dryness, low libido_
...
- **Vaginal-specific probiotics — for tissue health and comfort**  _(medium priority)_
  Some women try vaginal-specific probiotics for tissue health and comfort, on the theory that it can help with a physical barrier to libido — dryness or discomfort. The evidence for this specific use is limited, and it isn't a substitute for treatments with a stronger evidence base, like vaginal oestrogen, if dryness or discomfort is significantly affecting you.
  _Targets: low libido, vaginal dryness_
...
Shown when their **symptoms** is any of: "skin changes", "hair changes".

### Food & diet

- **Eat for collagen production — skin loses 30% in the first 5 years**  _(high priority)_
  Skin collagen declines by approximately 30% in the first five years post-menopause, and around 2% per year thereafter. This is driven by oestrogen loss, not age per se. To support collagen synthesis: eat vitamin C-rich foods daily (citrus, red pepper, kiwi, broccoli); include protein at every meal (collagen is made from amino acids); and limit sugar and ultra-processed foods which drive glycation — a process that cross-links and damages collagen.
  _Targets: skin changes_
- **Protein, zinc, and iron — the nutrient triad for hair loss**  _(high priority)_
  Hair loss in menopause is partly hormonal (androgenic alopecia as the oestrogen:androgen ratio shifts), but nutritional deficiencies accelerate it significantly. The most common deficiencies in perimenopausal women are iron (particularly ferritin — ask for a ferritin test, not just haemoglobin) and protein. Zinc-rich foods (pumpkin seeds, oysters, beef, lentils) and biotin-containing foods (eggs, nuts, sweet potato) also support hair follicle health.
  _Targets: hair changes_
- **Omega-3 fats restore the skin's moisture barrier**  _(medium priority)_
  The skin's lipid barrier weakens as oestrogen declines, causing dryness, sensitivity, and impaired healing. Omega-3 fatty acids (oily fish, flaxseed, walnuts, algae oil) directly incorporate into skin cell membranes and strengthen the moisture barrier. A 12-week increase in oily fish consumption (3x weekly) produces measurable improvements in skin hydration and texture.
  _Targets: skin changes_

### Lifestyle

- **SPF every day — thinning skin burns and ages much faster**  _(high priority)_
  Post-menopausal skin is thinner, produces less melanin, and heals more slowly. UV exposure is the primary driver of visible skin ageing — more impactful than any other environmental factor. Apply a broad-spectrum SPF 30–50 to face, neck, and décolletage every morning, including in winter. This is the single most evidence-backed topical intervention for skin health.
  _Targets: skin changes_
- **Scalp massage and gentle handling — less breakage, better growth**  _(medium priority)_
  A 4-minute scalp massage daily (fingertips only, no nails) increases blood flow to hair follicles and has pilot evidence for improving hair thickness after 24 weeks. Use a wide-toothed comb on wet hair (which is elastic and breaks easily), reduce heat styling, and avoid tight hairstyles that create traction alopecia. Switching to a sulphate-free shampoo reduces scalp irritation.
  _Targets: hair changes_
- **Retinol — the most evidence-backed topical for skin ageing**  _(medium priority)_
  Retinol (vitamin A) is the only topical skincare ingredient with robust clinical evidence for stimulating collagen production and increasing skin cell turnover. Start with a low-concentration 0.1–0.25% formula twice weekly at night, increasing slowly. It takes 12 weeks to see results. It causes initial dryness and peeling — this is normal. Use an SPF in the morning when using retinol. Prescription-strength tretinoin is available from your GP for more significant results.
  _Targets: skin changes_

### Mindset & emotional

- **Hair loss is deeply affecting — it's not vanity to grieve it**  _(medium priority)_
  Hair loss in women carries a significant psychological burden. Studies show women with menopausal hair thinning report higher rates of social anxiety, self-consciousness, and reduced quality of life than men with comparable hair loss. These feelings are normal and proportionate. Getting an accurate diagnosis (ask for ferritin, thyroid, and androgens alongside the GP consultation) matters — much hair loss at this stage is addressable if caught early.
  _Targets: hair changes_
- **Your skin is changing — that does not mean it is failing you**  _(low priority)_
  Skin changes in menopause are among the most visually confronting aspects of the transition for many women. Western culture ties female value to youthful appearance in ways that make this harder than it needs to be. Your skin is adapting to a new hormonal environment. Caring for it consistently (nutrition, SPF, hydration, sleep) is the most productive response — not pursuing drastic interventions or withdrawing from social situations.
  _Targets: skin changes_
...
- **Biotin — only effective if you are actually deficient**  _(low priority)_
  ...
  _Targets: hair changes_
  _Disclaimer: High-dose biotin (>5mg/day) can cause false results on thyroid function tests, troponin tests, and other immunoassay blood tests. Inform your GP if you are taking biotin before any blood tests. Consult your GP before use._

---

## Sleep Problems & Fatigue

Shown when their **symptoms** is any of: "sleep problems", "fatigue".
...
- **Magnesium glycinate — for sleep quality**  _(high priority)_
  Magnesium glycinate (200–400mg, 30–60 minutes before bed) has good evidence for improving sleep onset and continuity. It relaxes smooth muscle, lowers cortisol, and supports GABA — the brain's main calming neurotransmitter. Start at 200mg and increase if needed.
  _Disclaimer: Supplements are not regulated medicines. Always check with your GP or pharmacist before starting, especially if you take any prescribed medications or have kidney or heart conditions._
...
- **CoQ10 (or Ubiquinol) — for cellular energy production**  _(medium priority)_
  CoQ10 is commonly taken at 100–200mg/day and is genuinely involved in cellular energy production, though the evidence that supplementing it measurably improves fatigue is mixed rather than settled. Ubiquinol is the "active" form your body converts the standard form (ubiquinone) into — that conversion may become less efficient with age, which is why some women choose ubiquinol, though it isn't firmly established as clinically better for everyone. Statins are known to lower CoQ10 levels in the body, which is the main reason it's often discussed specifically for women on statins or other heart medication.
  _Targets: fatigue_
  _Disclaimer: If you're on a statin or other heart medication, this should be GP-guided due to the interaction._
- **NMN and PQQ — emerging, not established, for energy support**  _(low priority)_
  NMN (Nicotinamide Mononucleotide, commonly 250–500mg/day) reliably raises NAD+ levels, which decline with age and are involved in cellular energy metabolism — but human trials haven't yet established that this translates into a clear fatigue benefit; most research so far is small and short-term. PQQ (Pyrroloquinoline Quinone, commonly 10–20mg/day) is sometimes paired with it and is generally well tolerated, with a similar gap between promising mechanism and proven outcome. Worth thinking of these as experimental rather than a reliable fix.
  _Targets: fatigue_
  _Disclaimer: Always check with your GP or pharmacist before starting, especially if you take any prescribed medications._
- **NAC and Glutathione — antioxidant support**  _(low priority)_
  NAC (N-Acetyl Cysteine, commonly 600mg/day) and/or glutathione support the body's master antioxidant system, which plays a role in cellular energy production and reducing oxidative stress. You may read that glutathione has to be liposomal to work — some studies show standard oral glutathione can raise levels in the body too, so it isn't a strict requirement, though formulation does affect absorption and research on the best form is still developing.
  _Targets: fatigue_
  _Disclaimer: Always check with your GP or pharmacist before starting, especially if you take any prescribed medications._

---

## Surgical Menopause — Abrupt Transition

Shown when their **menopause stage** is "surgical".

### Food & diet

- **Anti-inflammatory eating is especially important after oophorectomy**  _(high priority)_
  Surgical menopause removes the ovaries' protective oestrogen production suddenly rather than gradually. The inflammatory consequences — joint pain, vascular changes, cognitive changes — can be more pronounced than in natural menopause. An anti-inflammatory dietary pattern (Mediterranean, with emphasis on olive oil, oily fish, colourful vegetables, and limiting ultra-processed foods) helps mitigate this systemic inflammatory shift.
  _Targets: joint pain, hot flashes, mood changes_
- **Bone protection through diet is urgent — loss is faster after surgical menopause**  _(high priority)_
  Women who undergo bilateral oophorectomy before natural menopause lose bone density faster than those going through natural menopause. The earlier the surgery, the greater the long-term fracture risk. Calcium from food (700–1200mg daily) and vitamin D are non-negotiable. If you have not yet spoken to your GP about a DEXA scan to establish baseline bone density, prioritise this.

### Lifestyle

- **HRT after surgical menopause — the conversation your GP needs to have with you**  _(high priority)_
  For women who undergo surgical menopause before the age of 51 (the average age of natural menopause), HRT is recommended by most menopause specialists until at least that age. The risk of NOT taking HRT — elevated cardiovascular risk, bone loss, cognitive changes — is well-evidenced and significant. If you have not been offered or discussed HRT, make an appointment specifically about this. The British Menopause Society website has a GP finder for menopause specialists if your GP is not menopause-trained.
- **Start weight-bearing exercise as soon as you are cleared post-surgery**  _(high priority)_
  Weight-bearing exercise (walking, resistance training) is the most important lifestyle intervention for protecting bone density after surgical menopause. Get clearance from your surgeon on when to begin — for most women, gentle walking starts within weeks of surgery, with progressive strengthening from 6–8 weeks. Establishing this habit early in your recovery directly protects your long-term fracture risk.

### Mindset & emotional

- **Surgical menopause grief is real — and it is often unacknowledged**  _(high priority)_
  Women who enter menopause surgically — whether through cancer treatment, endometriosis, or other causes — frequently describe a profound and underacknowledged grief. The abruptness of the hormonal change compounds the emotional impact of the surgery itself. If you had surgery related to cancer or fertility loss, you may be navigating multiple significant losses simultaneously. This deserves proper psychological support — not just symptom management. Ask your surgical team or GP for a referral to a counsellor with experience in women's health.
- **Your body is adapting to a massive hormonal shift — give it time**  _(high priority)_
  The first 3–6 months after bilateral oophorectomy are often the most intense in terms of symptom severity. Hot flashes, sleep disruption, mood changes, and cognitive fog are common and often severe in this acute phase. This does not represent a permanent state. Symptoms typically settle over months as the body adapts, and with appropriate treatment (HRT, lifestyle changes) most women achieve a quality of life comparable to their pre-surgical baseline. What you are experiencing now is not your new normal.

### Supplements

- **Vitamin D — higher priority after surgical menopause**  _(high priority)_
  Vitamin D is especially important after surgical menopause given the accelerated bone loss. Ask your GP for a blood test to establish your 25(OH)D level. Many menopause specialists recommend 1000–2000 IU daily for women who have undergone oophorectomy. Always combine with calcium from food (not high-dose supplements). Take vitamin D3 (cholecalciferol) rather than D2, and with a meal containing fat for best absorption.
  _Disclaimer: Vitamin D supplementation above 2000 IU/day should be guided by a blood test result. Very high doses (above 4000 IU/day) can cause toxicity. Consult your GP before supplementing at high doses, especially if you have kidney disease or a history of kidney stones._
- **Omega-3 (EPA+DHA) — anti-inflammatory support after oophorectomy**  _(medium priority)_
  Omega-3 fatty acids (2000–3000mg EPA+DHA daily from fish oil or algae oil) reduce the inflammatory response that can be more pronounced after surgical menopause. There is also emerging evidence for neuroprotective benefits relevant to the cognitive changes some women experience after oophorectomy. Take with food.
  _Disclaimer: High-dose omega-3 (above 3g EPA+DHA) may thin the blood. If you are on anticoagulants or awaiting further surgery, consult your GP or pharmacist before supplementing. Algae-based omega-3 is the plant-based equivalent of fish oil._

---

## Weight Changes, Joint Pain & Low Energy

Shown when their **symptoms** is any of: "weight changes", "joint pain", "fatigue".

### Food & diet

- **Prioritise protein — muscle is your metabolic engine**  _(high priority)_
...
- **Weight changes in menopause are hormonal — not your fault**  _(high priority)_
...
- **Collagen Type II — specifically for joint cartilage**  _(medium priority)_
  There are two quite different products here, at very different doses — worth knowing which is which. Hydrolysed collagen (broken down into smaller peptides) is commonly used around 10g/day. Undenatured Type II collagen (often sold as UC-II) is a different, more concentrated preparation studied at a much lower dose, typically around 40mg/day — taking 10g of that would be far more than intended. Either way, Type II is the form associated with joint cartilage specifically, distinct from the Type I collagen used for hair, skin and nails.
...
- **Curcumin — for joint pain and stiffness**  _(medium priority)_
  Some women try curcumin, commonly around 500mg 2–4x/day, often paired with piperine (black pepper extract) to improve absorption. It's a reasonably well-researched anti-inflammatory, often used specifically for joint pain and stiffness.
  _Targets: joint pain_
  _Disclaimer: Enhanced-absorption curcumin products (those combined with piperine) have been linked to rare cases of liver injury, and can cause reflux at higher doses. Curcumin can also interact with blood-thinning medication. Always check with your GP or pharmacist before starting, especially if you take any prescribed medications or have liver concerns._
- **Glucosamine and Chondroitin**  _(medium priority)_
  Some women use glucosamine and chondroitin together, commonly around 1500mg glucosamine plus 1200mg chondroitin per day — a traditional joint-support combination, with some evidence for cartilage support and reducing joint discomfort, particularly in osteoarthritis.
  _Targets: joint pain_
  _Disclaimer: Can increase bleeding risk alongside warfarin, and may affect blood glucose levels — worth flagging if you're diabetic or on blood thinners. Caution if you have a shellfish allergy too, as glucosamine is often shellfish-derived. Consult your GP before use._
...
- **Berberine — for blood sugar and metabolic health**  _(medium priority)_
  ...
  _Disclaimer: Not suitable during pregnancy or breastfeeding. Can interact with blood sugar and blood pressure medications, and with several other medicines via how the liver processes them — this one especially needs a GP check first, and mention every medication you take._
