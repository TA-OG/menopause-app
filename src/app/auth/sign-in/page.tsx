    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6 bg-gradient-to-b from-brand-50 to-white">
        <div className="text-center max-w-sm">
          ...
          <p className="text-gray-600 text-sm">Magic link sent to <strong>{email}</strong>.</p>
    ...
    <div className="min-h-screen bg-gradient-to-b from-brand-50 to-white flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm">Sign in to your wellness plan.</p>
        </div>
        <button
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          No account? <Link href="/auth/sign-up" className="text-brand-700 font-medium">Sign up free</Link>
        </p>
      </div>
    </div>
  )
